```ECL:
title: ZiSE25 Tailoring
kind: tailoring
description: |
  Tailoring for the selection used in [ZiSE25](https://github.com/BUGSENG/ZiSE25).
authors:
- BUGSENG s.r.l.
- Ac6
options:
- id: BARR-C-configs
  kind: flag
  title: Additional commonly used BARR-C configurations
  default: true
```
