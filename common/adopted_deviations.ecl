...
-config=MC.R7.2,reports+={relied,adopted_report}
-config=MC.R10.3,reports+={relied,adopted_report}
-config=MC.R10.6,reports+={relied,adopted_report}
-config=MC.R12.1,reports+={relied,adopted_report}
-doc_end
...
-config=MC.R7.2,reports+={safe,"all_area(all_loc(any_exp(macro(^assert$))))"}
-doc_end
...
-config=MC.R2.3,declarations+={safe,"loc(top(public()))"}

-doc="Library entry points not necessarily have to be referenced."
-config=MC.R2.1,declarations+={safe,"loc(top(public()))"}
...
-config=MC.R8.6,declarations+={safe, "loc(top(file(^zephyr/build/zephyr/include/generated/.*$)))"}
