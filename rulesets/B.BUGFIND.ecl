````ECL:
title: ECLAIR Bug Finder
kind: ruleset
description: The ECLAIR Bug Finder ruleset.
authors:
- BUGSENG
provides:
  ruleset: B.BUGFIND
  ...
  - id: B.BUGFIND.core
    ...
    - id: B.BUGFIND.core.CallAndMessage
      ...
      description: |
        ...
        ```
      default: true
    - id: B.BUGFIND.core.CastToStruct
      kind: flag
      title: Check for cast from non-struct pointer to struct pointer
      description: |
        Enable/disable (rule) `B.BUGFIND.core.CastToStruct`.
        When enabled this functionally is equivalent to the following code:
        ```ecl
        -enable=B.BUGFIND.core.CastToStruct
        ```
        or, when disabled:
        ```ecl
        -disable=B.BUGFIND.core.CastToStruct
        ```
      default: true
    - id: B.BUGFIND.core.Conversion
      kind: flag
      title: Loss of sign/precision in implicit conversions
      description: |
        Enable/disable (rule) `B.BUGFIND.core.Conversion`.
        When enabled this functionally is equivalent to the following code:
        ```ecl
        -enable=B.BUGFIND.core.Conversion
        ```
        or, when disabled:
        ```ecl
        -disable=B.BUGFIND.core.Conversion
        ```
      default: true
  ...
  - id: B.BUGFIND.cplusplus
    ...
    - id: B.BUGFIND.cplusplus.VirtualCall
      ...
      description: |
        ...
        ```
      default: true
  - id: B.BUGFIND.deadcode
    kind: group
    children:
    - id: B.BUGFIND.deadcode.DeadStores
      kind: flag
      title: Check for values stored to variables that are never read afterwards
      description: |
        Enable/disable (rule) `B.BUGFIND.deadcode.DeadStores`.
        When enabled this functionally is equivalent to the following code:
        ```ecl
        -enable=B.BUGFIND.deadcode.DeadStores
        ```
        or, when disabled:
        ```ecl
        -disable=B.BUGFIND.deadcode.DeadStores
        ```
      default: true
  ...
  - id: B.BUGFIND.security
    ...
    - id: B.BUGFIND.security.cert.env.InvalidPtr
      ...
      description: |
        ...
        ```
      default: true
    - id: B.BUGFIND.security.insecureAPI
      kind: group
      children:
      - id: B.BUGFIND.security.insecureAPI.DeprecatedOrUnsafeBufferHandling
        kind: flag
        title: Warn on uses of unsecure or deprecated buffer manipulating functions
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.DeprecatedOrUnsafeBufferHandling`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.DeprecatedOrUnsafeBufferHandling
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.DeprecatedOrUnsafeBufferHandling
          ```
        default: true
      - id: B.BUGFIND.security.insecureAPI.SecuritySyntaxChecker
        kind: flag
        title: Base of various security function related checkers
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.SecuritySyntaxChecker`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.SecuritySyntaxChecker
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.SecuritySyntaxChecker
          ```
        default: true
      - id: B.BUGFIND.security.insecureAPI.UncheckedReturn
        kind: flag
        title: Warn on uses of functions whose return values must be always checked
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.UncheckedReturn`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.UncheckedReturn
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.UncheckedReturn
          ```
        default: true
      - id: B.BUGFIND.security.insecureAPI.bcmp
        kind: flag
        title: Warn on uses of the 'bcmp' function
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.bcmp`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.bcmp
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.bcmp
          ```
        default: true
      - id: B.BUGFIND.security.insecureAPI.bcopy
        kind: flag
        title: Warn on uses of the 'bcopy' function
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.bcopy`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.bcopy
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.bcopy
          ```
        default: true
      - id: B.BUGFIND.security.insecureAPI.bzero
        kind: flag
        title: Warn on uses of the 'bzero' function
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.bzero`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.bzero
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.bzero
          ```
        default: true
      - id: B.BUGFIND.security.insecureAPI.getpw
        kind: flag
        title: Warn on uses of the 'getpw' function
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.getpw`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.getpw
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.getpw
          ```
        default: true
      - id: B.BUGFIND.security.insecureAPI.gets
        kind: flag
        title: Warn on uses of the 'gets' function
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.gets`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.gets
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.gets
          ```
        default: true
      - id: B.BUGFIND.security.insecureAPI.mkstemp
        kind: flag
        title: Warn when 'mkstemp' is passed fewer than 6 X's in the format string
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.mkstemp`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.mkstemp
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.mkstemp
          ```
        default: true
      - id: B.BUGFIND.security.insecureAPI.mktemp
        kind: flag
        title: Warn on uses of the 'mktemp' function
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.mktemp`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.mktemp
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.mktemp
          ```
        default: true
      - id: B.BUGFIND.security.insecureAPI.rand
        kind: flag
        title: 'Warn on uses of the ''rand'', ''random'', and related functions'
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.rand`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.rand
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.rand
          ```
        default: true
      - id: B.BUGFIND.security.insecureAPI.strcpy
        kind: flag
        title: Warn on uses of the 'strcpy' and 'strcat' functions
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.strcpy`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.strcpy
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.strcpy
          ```
        default: true
      - id: B.BUGFIND.security.insecureAPI.vfork
        kind: flag
        title: Warn on uses of the 'vfork' function
        description: |
          Enable/disable (rule) `B.BUGFIND.security.insecureAPI.vfork`.
          When enabled this functionally is equivalent to the following code:
          ```ecl
          -enable=B.BUGFIND.security.insecureAPI.vfork
          ```
          or, when disabled:
          ```ecl
          -disable=B.BUGFIND.security.insecureAPI.vfork
          ```
        default: true
  - id: B.BUGFIND.taint
    kind: group
...
if(b_bugfind_core_casttostruct,
  progn(
    doc("Enabled by flag b_bugfind_core_casttostruct"),
    enable("B.BUGFIND.core.CastToStruct")
  ),
  progn(
    doc("Disabled by flag b_bugfind_core_casttostruct"),
    disable("B.BUGFIND.core.CastToStruct")
  )
)

if(b_bugfind_core_conversion,
  progn(
    doc("Enabled by flag b_bugfind_core_conversion"),
    enable("B.BUGFIND.core.Conversion")
  ),
  progn(
    doc("Disabled by flag b_bugfind_core_conversion"),
    disable("B.BUGFIND.core.Conversion")
  )
)
...
if(b_bugfind_deadcode_deadstores,
  progn(
    doc("Enabled by flag b_bugfind_deadcode_deadstores"),
    enable("B.BUGFIND.deadcode.DeadStores")
  ),
  progn(
    doc("Disabled by flag b_bugfind_deadcode_deadstores"),
    disable("B.BUGFIND.deadcode.DeadStores")
  )
)
...
if(b_bugfind_security_insecureapi_deprecatedorunsafebufferhandling,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_deprecatedorunsafebufferhandling"),
    enable("B.BUGFIND.security.insecureAPI.DeprecatedOrUnsafeBufferHandling")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_deprecatedorunsafebufferhandling"),
    disable("B.BUGFIND.security.insecureAPI.DeprecatedOrUnsafeBufferHandling")
  )
)

if(b_bugfind_security_insecureapi_securitysyntaxchecker,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_securitysyntaxchecker"),
    enable("B.BUGFIND.security.insecureAPI.SecuritySyntaxChecker")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_securitysyntaxchecker"),
    disable("B.BUGFIND.security.insecureAPI.SecuritySyntaxChecker")
  )
)

if(b_bugfind_security_insecureapi_uncheckedreturn,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_uncheckedreturn"),
    enable("B.BUGFIND.security.insecureAPI.UncheckedReturn")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_uncheckedreturn"),
    disable("B.BUGFIND.security.insecureAPI.UncheckedReturn")
  )
)

if(b_bugfind_security_insecureapi_bcmp,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_bcmp"),
    enable("B.BUGFIND.security.insecureAPI.bcmp")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_bcmp"),
    disable("B.BUGFIND.security.insecureAPI.bcmp")
  )
)

if(b_bugfind_security_insecureapi_bcopy,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_bcopy"),
    enable("B.BUGFIND.security.insecureAPI.bcopy")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_bcopy"),
    disable("B.BUGFIND.security.insecureAPI.bcopy")
  )
)

if(b_bugfind_security_insecureapi_bzero,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_bzero"),
    enable("B.BUGFIND.security.insecureAPI.bzero")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_bzero"),
    disable("B.BUGFIND.security.insecureAPI.bzero")
  )
)

if(b_bugfind_security_insecureapi_getpw,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_getpw"),
    enable("B.BUGFIND.security.insecureAPI.getpw")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_getpw"),
    disable("B.BUGFIND.security.insecureAPI.getpw")
  )
)

if(b_bugfind_security_insecureapi_gets,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_gets"),
    enable("B.BUGFIND.security.insecureAPI.gets")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_gets"),
    disable("B.BUGFIND.security.insecureAPI.gets")
  )
)

if(b_bugfind_security_insecureapi_mkstemp,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_mkstemp"),
    enable("B.BUGFIND.security.insecureAPI.mkstemp")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_mkstemp"),
    disable("B.BUGFIND.security.insecureAPI.mkstemp")
  )
)

if(b_bugfind_security_insecureapi_mktemp,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_mktemp"),
    enable("B.BUGFIND.security.insecureAPI.mktemp")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_mktemp"),
    disable("B.BUGFIND.security.insecureAPI.mktemp")
  )
)

if(b_bugfind_security_insecureapi_rand,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_rand"),
    enable("B.BUGFIND.security.insecureAPI.rand")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_rand"),
    disable("B.BUGFIND.security.insecureAPI.rand")
  )
)

if(b_bugfind_security_insecureapi_strcpy,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_strcpy"),
    enable("B.BUGFIND.security.insecureAPI.strcpy")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_strcpy"),
    disable("B.BUGFIND.security.insecureAPI.strcpy")
  )
)

if(b_bugfind_security_insecureapi_vfork,
  progn(
    doc("Enabled by flag b_bugfind_security_insecureapi_vfork"),
    enable("B.BUGFIND.security.insecureAPI.vfork")
  ),
  progn(
    doc("Disabled by flag b_bugfind_security_insecureapi_vfork"),
    disable("B.BUGFIND.security.insecureAPI.vfork")
  )
)
